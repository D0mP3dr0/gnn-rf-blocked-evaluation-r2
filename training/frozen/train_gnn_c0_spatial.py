...
"""Frozen GNN-RF training script covering items C0 and C1 of the resubmission roadmap (Access-2026-29524)."""
...
def induzir_particao(base: HeteroData, idx_t: torch.Tensor, n_antenna: int,
    ...
    """
    Subgraph induced by terrain nodes `idx_t` (plus all antenna nodes). No
    edge crosses the partition boundary.
    """
